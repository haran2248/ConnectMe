        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for(DataSnapshot shot:dataSnapshot.getChildren())
                {
                    ...
                    {
                        if(shot.child("information").child("Info").getValue(Info.class).getImage()!=null&&!(shot.child("information").child("Info").getValue(Info.class).getImage().equals("")))
                        ...
                        interests_in_xml.setText(shot.child("information").child("Info").getValue(Info.class).getInterests());
...
//                        Log.i("Interests",shot.getValue(User.class).getInterests());
                        ...
                        fav_movies_in_xml.setText(shot.child("information").child("Info").getValue(Info.class).getMovies());
